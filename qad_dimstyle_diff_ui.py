...
class Ui_DimStyle_Diff_Dialog(object):
    def setupUi(self, DimStyle_Diff_Dialog):
        ...
        self.tableWidget = QtWidgets.QTableWidget(parent=DimStyle_Diff_Dialog)
        self.tableWidget.setGeometry(QtCore.QRect(10, 110, 421, 371))
        self.tableWidget.setObjectName("tableWidget")
        self.tableWidget.setColumnCount(0)
        self.tableWidget.setRowCount(0)
        self.copyButton = QtWidgets.QPushButton(parent=DimStyle_Diff_Dialog)
        self.copyButton.setGeometry(QtCore.QRect(404, 80, 31, 23))
        self.copyButton.setText("")
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(":/plugins/qad/icons/copy.svg"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        self.copyButton.setIcon(icon)
        self.copyButton.setObjectName("copyButton")

        self.retranslateUi(DimStyle_Diff_Dialog)
        self.helpButton.clicked.connect(DimStyle_Diff_Dialog.ButtonHELP_Pressed) # type: ignore
        self.dimStyle1.currentIndexChanged['int'].connect(DimStyle_Diff_Dialog.DimStyleName1Changed) # type: ignore
        self.dimStyle2.currentIndexChanged['int'].connect(DimStyle_Diff_Dialog.DimStyleName2Changed) # type: ignore
        self.copyButton.clicked.connect(DimStyle_Diff_Dialog.copyToClipboard) # type: ignore
        self.closeButton.clicked.connect(DimStyle_Diff_Dialog.accept) # type: ignore
