...
class Ui_DimInput_Settings_Dialog(object):
    def setupUi(self, DimInput_Settings_Dialog):
        ...
        DimInput_Settings_Dialog.resize(400, 346)
        ...
        DimInput_Settings_Dialog.setMinimumSize(QtCore.QSize(400, 346))
        DimInput_Settings_Dialog.setMaximumSize(QtCore.QSize(400, 346))
        self.layoutWidget = QtWidgets.QWidget(parent=DimInput_Settings_Dialog)
        self.layoutWidget.setGeometry(QtCore.QRect(100, 310, 295, 30))
        ...
        self.groupBox = QtWidgets.QGroupBox(parent=DimInput_Settings_Dialog)
        ...
        self.radioShow1Dim = QtWidgets.QRadioButton(parent=self.groupBox)
        self.radioShow1Dim.setGeometry(QtCore.QRect(10, 50, 361, 17))
        self.radioShow1Dim.setObjectName("radioShow1Dim")
        self.radioShow2Dim = QtWidgets.QRadioButton(parent=self.groupBox)
        self.radioShow2Dim.setGeometry(QtCore.QRect(10, 80, 361, 17))
        self.radioShow2Dim.setObjectName("radioShow2Dim")
        self.radioShowMoreDim = QtWidgets.QRadioButton(parent=self.groupBox)
        self.radioShowMoreDim.setGeometry(QtCore.QRect(10, 110, 361, 17))
        self.radioShowMoreDim.setObjectName("radioShowMoreDim")
        self.checkAbsoluteAngle = QtWidgets.QCheckBox(parent=self.groupBox)
        self.checkAbsoluteAngle.setGeometry(QtCore.QRect(30, 200, 151, 17))
        self.checkAbsoluteAngle.setObjectName("checkAbsoluteAngle")
        self.checkResultingDim = QtWidgets.QCheckBox(parent=self.groupBox)
        self.checkResultingDim.setGeometry(QtCore.QRect(30, 140, 151, 17))
        self.checkResultingDim.setObjectName("checkResultingDim")
        self.checkLengthChange = QtWidgets.QCheckBox(parent=self.groupBox)
        self.checkLengthChange.setGeometry(QtCore.QRect(30, 170, 151, 17))
        self.checkLengthChange.setObjectName("checkLengthChange")
        self.checkAngleChange = QtWidgets.QCheckBox(parent=self.groupBox)
        ...
        self.label_2.setGeometry(QtCore.QRect(50, 240, 321, 41))
        ...
        self.radioShowMoreDim.clicked.connect(DimInput_Settings_Dialog.radioShowMoreDimChecked) # type: ignore
        self.cancelButton.clicked.connect(DimInput_Settings_Dialog.reject) # type: ignore
        self.okButton.clicked.connect(DimInput_Settings_Dialog.ButtonBOX_Accepted) # type: ignore
