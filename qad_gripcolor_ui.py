...
class Ui_GripColor_Dialog(object):
    def setupUi(self, GripColor_Dialog):
        ...
        self.buttonBox = QtWidgets.QDialogButtonBox(parent=GripColor_Dialog)
        ...
        self.groupBox = QtWidgets.QGroupBox(parent=GripColor_Dialog)
        ...
        self.unselectedGripColorDummy = QtWidgets.QPushButton(parent=self.groupBox)
        ...
        self.selectedGripColorDummy = QtWidgets.QPushButton(parent=self.groupBox)
        ...
        self.hoverGripColorDummy = QtWidgets.QPushButton(parent=self.groupBox)
        ...
        self.contourGripColorDummy = QtWidgets.QPushButton(parent=self.groupBox)
        ...
        self.buttonBox.rejected.connect(GripColor_Dialog.reject) # type: ignore
        self.buttonBox.helpRequested.connect(GripColor_Dialog.ButtonHELP_Pressed) # type: ignore
        self.buttonBox.accepted.connect(GripColor_Dialog.ButtonBOX_Accepted) # type: ignore
