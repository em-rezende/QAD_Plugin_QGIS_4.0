...
class Ui_DimStyle_Dialog(object):
    def setupUi(self, DimStyle_Dialog):
        ...
        DimStyle_Dialog.setWindowModality(QtCore.Qt.WindowModality.WindowModal)
        ...
        self.label_3 = QtWidgets.QLabel(parent=DimStyle_Dialog)
        self.label_3.setGeometry(QtCore.QRect(190, 40, 101, 16))
        self.label_3.setObjectName("label_3")
        self.selectedStyle = QtWidgets.QLabel(parent=DimStyle_Dialog)
        self.selectedStyle.setGeometry(QtCore.QRect(300, 40, 221, 20))
        self.selectedStyle.setObjectName("selectedStyle")
        self.layoutWidget = QtWidgets.QWidget(parent=DimStyle_Dialog)
        ...
        self.previewDummy = QtWidgets.QPushButton(parent=DimStyle_Dialog)
        ...
        self.SetCurrent.clicked.connect(DimStyle_Dialog.setCurrentStyle) # type: ignore
        self.new_2.clicked.connect(DimStyle_Dialog.createNewStyle) # type: ignore
        self.Mod.clicked.connect(DimStyle_Dialog.modStyle) # type: ignore
        self.dimStyleList.customContextMenuRequested['QPoint'].connect(DimStyle_Dialog.displayPopupMenu) # type: ignore
        self.TempMod.clicked.connect(DimStyle_Dialog.temporaryModStyle) # type: ignore
        self.helpButton.clicked.connect(DimStyle_Dialog.ButtonHELP_Pressed) # type: ignore
        self.Diff.clicked.connect(DimStyle_Dialog.showDiffBetweenStyles) # type: ignore
        self.closeButton.clicked.connect(DimStyle_Dialog.accept) # type: ignore
