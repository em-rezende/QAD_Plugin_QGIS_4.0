...
class Ui_PointerInput_Settings_Dialog(object):
    def setupUi(self, PointerInput_Settings_Dialog):
        ...
        self.groupBox = QtWidgets.QGroupBox(parent=PointerInput_Settings_Dialog)
        ...
        self.radioPolarFmt = QtWidgets.QRadioButton(parent=self.groupBox_3)
        self.radioPolarFmt.setGeometry(QtCore.QRect(10, 10, 241, 17))
        self.radioPolarFmt.setObjectName("radioPolarFmt")
        self.radioCartesianFmt = QtWidgets.QRadioButton(parent=self.groupBox_3)
        ...
        self.layoutWidget = QtWidgets.QWidget(parent=PointerInput_Settings_Dialog)
